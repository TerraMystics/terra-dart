...
//  source: lib/src/proto/third_party/tendermint/abci/types.proto
//
// @dart = 2.12
...
const RequestBeginBlock$json = const {
  ...
  '2': const [
    ...
    const {'1': 'header', '3': 2, '4': 1, '5': 11, '6': '.tendermint.abci.Header', '8': const {}, '10': 'header'},
...
final $typed_data.Uint8List requestBeginBlockDescriptor = $convert.base64Decode('');
...
const ResponseQuery$json = const {
  ...
  '2': const [
    ...
    const {'1': 'proof_ops', '3': 8, '4': 1, '5': 11, '6': '.tendermint.abci.ProofOps', '10': 'proofOps'},
...
final $typed_data.Uint8List responseQueryDescriptor = $convert.base64Decode('');
...
const ConsensusParams$json = const {
  ...
  '2': const [
    ...
    const {'1': 'evidence', '3': 2, '4': 1, '5': 11, '6': '.tendermint.abci.EvidenceParams', '10': 'evidence'},
    const {'1': 'validator', '3': 3, '4': 1, '5': 11, '6': '.tendermint.abci.ValidatorParams', '10': 'validator'},
    const {'1': 'version', '3': 4, '4': 1, '5': 11, '6': '.tendermint.abci.VersionParams', '10': 'version'},
  ],
};

/// Descriptor for `ConsensusParams`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List consensusParamsDescriptor = $convert.base64Decode('');
...
const ValidatorUpdate$json = const {
  '1': 'ValidatorUpdate',
  '2': const [
    const {'1': 'pub_key', '3': 1, '4': 1, '5': 11, '6': '.tendermint.abci.PublicKey', '8': const {}, '10': 'pubKey'},
    const {'1': 'power', '3': 2, '4': 1, '5': 3, '10': 'power'},
  ],
};

/// Descriptor for `ValidatorUpdate`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List validatorUpdateDescriptor = $convert.base64Decode('Cg9WYWxpZGF0b3JVcGRhdGUSOQoHcHViX2tleRgBIAEoCzIaLnRlbmRlcm1pbnQuYWJjaS5QdWJsaWNLZXlCBMjeHwBSBnB1YktleRIUCgVwb3dlchgCIAEoA1IFcG93ZXI=');
...
final $typed_data.Uint8List proofOpsDescriptor = $convert.base64Decode('CghQcm9vZk9wcw==');
...
final $typed_data.Uint8List evidenceParamsDescriptor = $convert.base64Decode('Cg5FdmlkZW5jZVBhcmFtcw==');
...
final $typed_data.Uint8List validatorParamsDescriptor = $convert.base64Decode('Cg9WYWxpZGF0b3JQYXJhbXM=');
...
final $typed_data.Uint8List versionParamsDescriptor = $convert.base64Decode('Cg1WZXJzaW9uUGFyYW1z');
...
final $typed_data.Uint8List publicKeyDescriptor = $convert.base64Decode('CglQdWJsaWNLZXk=');
...
final $typed_data.Uint8List headerDescriptor = $convert.base64Decode('CgZIZWFkZXI=');
