...
//  source: lib/src/proto/third_party/tendermint/types/evidence.proto
//
// @dart = 2.12
...
class DuplicateVoteEvidence extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  Vote ensureVoteA() => $_ensure(0);

  @$pb.TagNumber(2)
  Vote get voteB => $_getN(1);
  @$pb.TagNumber(2)
  set voteB(Vote v) {
    setField(2, v);
  }
...
class LightClientAttackEvidence extends $pb.GeneratedMessage {
  ...
  factory LightClientAttackEvidence({
    ...
    $core.Iterable<Validator>? byzantineValidators,
    $fixnum.Int64? totalVotingPower,
    $0.Timestamp? timestamp,
  }) {
    final _result = create();
  ...
  @$pb.TagNumber(1)
  LightBlock get conflictingBlock => $_getN(0);
  @$pb.TagNumber(1)
  set conflictingBlock(LightBlock v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  LightBlock ensureConflictingBlock() => $_ensure(0);
  ...
  @$pb.TagNumber(3)
  $core.List<Validator> get byzantineValidators => $_getList(2);
