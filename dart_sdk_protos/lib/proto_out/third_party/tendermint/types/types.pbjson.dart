...
//  source: lib/src/proto/third_party/tendermint/types/types.proto
//
// @dart = 2.12
...
const Part$json = const {
  ...
  '2': const [
    ...
    const {'1': 'proof', '3': 3, '4': 1, '5': 11, '6': '.tendermint.types.Proof', '8': const {}, '10': 'proof'},
  ],
};

/// Descriptor for `Part`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List partDescriptor = $convert.base64Decode('CgRQYXJ0EhQKBWluZGV4GAEgASgNUgVpbmRleBIUCgVieXRlcxgCIAEoDFIFYnl0ZXMSMwoFcHJvb2YYAyABKAsyFy50ZW5kZXJtaW50LnR5cGVzLlByb29mQgTI3h8AUgVwcm9vZg==');
...
const Header$json = const {
  '1': 'Header',
  '2': const [
    const {'1': 'version', '3': 1, '4': 1, '5': 11, '6': '.tendermint.types.Consensus', '8': const {}, '10': 'version'},
...
final $typed_data.Uint8List headerDescriptor = $convert.base64Decode('');
...
const TxProof$json = const {
  ...
  '2': const [
    ...
    const {'1': 'proof', '3': 3, '4': 1, '5': 11, '6': '.tendermint.types.Proof', '10': 'proof'},
  ],
};

/// Descriptor for `TxProof`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List txProofDescriptor = $convert.base64Decode('CgdUeFByb29mEhsKCXJvb3RfaGFzaBgBIAEoDFIIcm9vdEhhc2gSEgoEZGF0YRgCIAEoDFIEZGF0YRItCgVwcm9vZhgDIAEoCzIXLnRlbmRlcm1pbnQudHlwZXMuUHJvb2ZSBXByb29m');
...
final $typed_data.Uint8List consensusDescriptor = $convert.base64Decode('CglDb25zZW5zdXM=');
...
final $typed_data.Uint8List proofDescriptor = $convert.base64Decode('CgVQcm9vZg==');
