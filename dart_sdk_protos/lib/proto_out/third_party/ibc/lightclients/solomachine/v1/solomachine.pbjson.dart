...
const ConnectionStateData$json = const {
  ...
  '2': const [
    const {'1': 'path', '3': 1, '4': 1, '5': 12, '10': 'path'},
    const {'1': 'connection', '3': 2, '4': 1, '5': 11, '6': '.ibc.lightclients.solomachine.v1.ConnectionEnd', '10': 'connection'},
  ],
  '7': const {},
};

/// Descriptor for `ConnectionStateData`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List connectionStateDataDescriptor = $convert.base64Decode('ChNDb25uZWN0aW9uU3RhdGVEYXRhEhIKBHBhdGgYASABKAxSBHBhdGgSTgoKY29ubmVjdGlvbhgCIAEoCzIuLmliYy5saWdodGNsaWVudHMuc29sb21hY2hpbmUudjEuQ29ubmVjdGlvbkVuZFIKY29ubmVjdGlvbjoEiKAfAA==');
@$core.Deprecated('Use channelStateDataDescriptor instead')
const ChannelStateData$json = const {
  '1': 'ChannelStateData',
  '2': const [
    const {'1': 'path', '3': 1, '4': 1, '5': 12, '10': 'path'},
    const {'1': 'channel', '3': 2, '4': 1, '5': 11, '6': '.ibc.lightclients.solomachine.v1.Channel', '10': 'channel'},
  ],
  '7': const {},
};

/// Descriptor for `ChannelStateData`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List channelStateDataDescriptor = $convert.base64Decode('ChBDaGFubmVsU3RhdGVEYXRhEhIKBHBhdGgYASABKAxSBHBhdGgSQgoHY2hhbm5lbBgCIAEoCzIoLmliYy5saWdodGNsaWVudHMuc29sb21hY2hpbmUudjEuQ2hhbm5lbFIHY2hhbm5lbDoEiKAfAA==');
