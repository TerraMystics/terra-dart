...
//  source: lib/src/proto/third_party/ibc/lightclients/solomachine/v2/solomachine.proto
//
// @dart = 2.12
...
const ClientState$json = const {
  ...
  '2': const [
    ...
    const {'1': 'is_frozen', '3': 2, '4': 1, '5': 8, '8': const {}, '10': 'isFrozen'},
    const {'1': 'consensus_state', '3': 3, '4': 1, '5': 11, '6': '.ibc.lightclients.solomachine.v2.ConsensusState', '8': const {}, '10': 'consensusState'},
...
final $typed_data.Uint8List clientStateDescriptor = $convert.base64Decode('');
...
const Misbehaviour$json = const {
  ...
  '2': const [
    ...
    const {'1': 'signature_one', '3': 3, '4': 1, '5': 11, '6': '.ibc.lightclients.solomachine.v2.SignatureAndData', '8': const {}, '10': 'signatureOne'},
    const {'1': 'signature_two', '3': 4, '4': 1, '5': 11, '6': '.ibc.lightclients.solomachine.v2.SignatureAndData', '8': const {}, '10': 'signatureTwo'},
  ],
  '7': const {},
};

/// Descriptor for `Misbehaviour`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List misbehaviourDescriptor = $convert.base64Decode('');
...
const SignatureAndData$json = const {
  ...
  '2': const [
    ...
    const {'1': 'data_type', '3': 2, '4': 1, '5': 14, '6': '.ibc.lightclients.solomachine.v2.DataType', '8': const {}, '10': 'dataType'},
...
final $typed_data.Uint8List signatureAndDataDescriptor = $convert.base64Decode('');
...
const SignBytes$json = const {
  ...
  '2': const [
    ...
    const {'1': 'data_type', '3': 4, '4': 1, '5': 14, '6': '.ibc.lightclients.solomachine.v2.DataType', '8': const {}, '10': 'dataType'},
...
final $typed_data.Uint8List signBytesDescriptor = $convert.base64Decode('');
...
const ConnectionStateData$json = const {
  ...
  '2': const [
    const {'1': 'path', '3': 1, '4': 1, '5': 12, '10': 'path'},
    const {'1': 'connection', '3': 2, '4': 1, '5': 11, '6': '.ibc.lightclients.solomachine.v2.ConnectionEnd', '10': 'connection'},
  ],
  '7': const {},
};

/// Descriptor for `ConnectionStateData`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List connectionStateDataDescriptor = $convert.base64Decode('ChNDb25uZWN0aW9uU3RhdGVEYXRhEhIKBHBhdGgYASABKAxSBHBhdGgSTgoKY29ubmVjdGlvbhgCIAEoCzIuLmliYy5saWdodGNsaWVudHMuc29sb21hY2hpbmUudjIuQ29ubmVjdGlvbkVuZFIKY29ubmVjdGlvbjoEiKAfAA==');
@$core.Deprecated('Use channelStateDataDescriptor instead')
const ChannelStateData$json = const {
  '1': 'ChannelStateData',
  '2': const [
    const {'1': 'path', '3': 1, '4': 1, '5': 12, '10': 'path'},
    const {'1': 'channel', '3': 2, '4': 1, '5': 11, '6': '.ibc.lightclients.solomachine.v2.Channel', '10': 'channel'},
  ],
  '7': const {},
};

/// Descriptor for `ChannelStateData`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List channelStateDataDescriptor = $convert.base64Decode('ChBDaGFubmVsU3RhdGVEYXRhEhIKBHBhdGgYASABKAxSBHBhdGgSQgoHY2hhbm5lbBgCIAEoCzIoLmliYy5saWdodGNsaWVudHMuc29sb21hY2hpbmUudjIuQ2hhbm5lbFIHY2hhbm5lbDoEiKAfAA==');
