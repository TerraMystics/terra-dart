...
//  source: lib/src/proto/third_party/ibc/core/client/v1/genesis.proto
//
// @dart = 2.12
...
class GenesisState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<ClientConsensusStates>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'clientsConsensus',
        $pb.PbFieldType.PM,
        subBuilder: ClientConsensusStates.create)
  ...
  factory GenesisState({
    $core.Iterable<IdentifiedClientState>? clients,
    $core.Iterable<ClientConsensusStates>? clientsConsensus,
  ...
  @$pb.TagNumber(1)
  $core.List<IdentifiedClientState> get clients => $_getList(0);

  @$pb.TagNumber(2)
  $core.List<ClientConsensusStates> get clientsConsensus => $_getList(1);

  @$pb.TagNumber(3)
  $core.List<IdentifiedGenesisMetadata> get clientsMetadata => $_getList(2);

  @$pb.TagNumber(4)
  Params get params => $_getN(3);
  @$pb.TagNumber(4)
  set params(Params v) {
    setField(4, v);
  }
