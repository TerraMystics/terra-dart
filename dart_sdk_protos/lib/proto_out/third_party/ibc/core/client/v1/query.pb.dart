...
class QueryClientStateResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $0.Any ensureClientState() => $_ensure(0);
...
class QueryClientStatesResponse extends $pb.GeneratedMessage {
  ...
  factory QueryClientStatesResponse({
    $core.Iterable<IdentifiedClientState>? clientStates,
  ...
  @$pb.TagNumber(1)
  $core.List<IdentifiedClientState> get clientStates => $_getList(0);
...
class QueryConsensusStatesResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $core.List<ConsensusStateWithHeight> get consensusStates => $_getList(0);
...
class QueryUpgradedClientStateResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $0.Any get upgradedClientState => $_getN(0);
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(1)
  $0.Any ensureUpgradedClientState() => $_ensure(0);
}
...
class QueryUpgradedConsensusStateResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $0.Any get upgradedConsensusState => $_getN(0);
  @$pb.TagNumber(1)
  set upgradedConsensusState($0.Any v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $0.Any ensureUpgradedConsensusState() => $_ensure(0);
}
