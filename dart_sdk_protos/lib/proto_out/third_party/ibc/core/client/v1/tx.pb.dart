...
//  source: lib/src/proto/third_party/ibc/core/client/v1/tx.proto
//
// @dart = 2.12
...
class MsgUpgradeClient extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  $0.Any get consensusState => $_getN(2);
  @$pb.TagNumber(3)
  set consensusState($0.Any v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $0.Any ensureConsensusState() => $_ensure(2);
...
class MsgSubmitMisbehaviour extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  $0.Any get misbehaviour => $_getN(1);
  @$pb.TagNumber(2)
  set misbehaviour($0.Any v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $0.Any ensureMisbehaviour() => $_ensure(1);
