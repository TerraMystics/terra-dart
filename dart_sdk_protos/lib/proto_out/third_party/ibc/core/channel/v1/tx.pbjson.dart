...
//  source: lib/src/proto/third_party/ibc/core/channel/v1/tx.proto
//
// @dart = 2.12
...
final $typed_data.Uint8List msgChannelOpenInitResponseDescriptor = $convert.base64Decode('ChpNc2dDaGFubmVsT3BlbkluaXRSZXNwb25zZQ==');
...
const MsgChannelOpenTry$json = const {
  ...
  '2': const [
    ...
    const {'1': 'proof_height', '3': 6, '4': 1, '5': 11, '6': '.ibc.core.channel.v1.Height', '8': const {}, '10': 'proofHeight'},
...
final $typed_data.Uint8List msgChannelOpenTryDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List msgChannelOpenTryResponseDescriptor = $convert.base64Decode('ChlNc2dDaGFubmVsT3BlblRyeVJlc3BvbnNl');
...
final $typed_data.Uint8List msgChannelOpenConfirmDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List msgChannelCloseConfirmDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List msgRecvPacketDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List msgRecvPacketResponseDescriptor = $convert.base64Decode('ChVNc2dSZWN2UGFja2V0UmVzcG9uc2U=');
...
final $typed_data.Uint8List msgTimeoutDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List msgTimeoutResponseDescriptor = $convert.base64Decode('ChJNc2dUaW1lb3V0UmVzcG9uc2U=');
...
final $typed_data.Uint8List msgTimeoutOnCloseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List msgTimeoutOnCloseResponseDescriptor = $convert.base64Decode('ChlNc2dUaW1lb3V0T25DbG9zZVJlc3BvbnNl');
...
final $typed_data.Uint8List msgAcknowledgementDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List msgAcknowledgementResponseDescriptor = $convert.base64Decode('ChpNc2dBY2tub3dsZWRnZW1lbnRSZXNwb25zZQ==');
...
final $typed_data.Uint8List packetDescriptor = $convert.base64Decode('CgZQYWNrZXQ=');
