...
class QueryPacketCommitmentsRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  PageRequest get pagination => $_getN(2);
  @$pb.TagNumber(3)
  set pagination(PageRequest v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  PageRequest ensurePagination() => $_ensure(2);
}
...
class QueryPacketCommitmentsResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $core.List<PacketState> get commitments => $_getList(0);
...
class QueryPacketAcknowledgementsResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $core.List<PacketState> get acknowledgements => $_getList(0);
