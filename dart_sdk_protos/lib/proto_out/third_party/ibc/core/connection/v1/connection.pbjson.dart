...
//  source: lib/src/proto/third_party/ibc/core/connection/v1/connection.proto
//
// @dart = 2.12
...
const Counterparty$json = const {
  ...
  '2': const [
    ...
    const {'1': 'prefix', '3': 3, '4': 1, '5': 11, '6': '.ibc.core.connection.v1.MerklePrefix', '8': const {}, '10': 'prefix'},
  ],
  '7': const {},
};

/// Descriptor for `Counterparty`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List counterpartyDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List merklePrefixDescriptor = $convert.base64Decode('CgxNZXJrbGVQcmVmaXg=');
