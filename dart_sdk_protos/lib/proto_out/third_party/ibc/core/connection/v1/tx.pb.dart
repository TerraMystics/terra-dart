...
class MsgConnectionOpenInit extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  Counterparty get counterparty => $_getN(1);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(2)
  Counterparty ensureCounterparty() => $_ensure(1);
  ...
  @$pb.TagNumber(3)
  Version ensureVersion() => $_ensure(2);
...
class MsgConnectionOpenTry extends $pb.GeneratedMessage {
  ...
  factory MsgConnectionOpenTry({
    ...
    Counterparty? counterparty,
    $fixnum.Int64? delayPeriod,
    $core.Iterable<Version>? counterpartyVersions,
    Height? proofHeight,
  ...
  @$pb.TagNumber(3)
  $0.Any ensureClientState() => $_ensure(2);
  ...
  @$pb.TagNumber(6)
  $core.List<Version> get counterpartyVersions => $_getList(5);

  @$pb.TagNumber(7)
  Height get proofHeight => $_getN(6);
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(7)
  Height ensureProofHeight() => $_ensure(6);
  ...
  @$pb.TagNumber(11)
  Height get consensusHeight => $_getN(10);
  @$pb.TagNumber(11)
  set consensusHeight(Height v) {
    setField(11, v);
  }
  ...
  @$pb.TagNumber(11)
  Height ensureConsensusHeight() => $_ensure(10);
...
class MsgConnectionOpenAck extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  $0.Any ensureClientState() => $_ensure(3);

  @$pb.TagNumber(5)
  Height get proofHeight => $_getN(4);
  @$pb.TagNumber(5)
  set proofHeight(Height v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  Height ensureProofHeight() => $_ensure(4);
  ...
  @$pb.TagNumber(9)
  Height get consensusHeight => $_getN(8);
  @$pb.TagNumber(9)
  set consensusHeight(Height v) {
    setField(9, v);
  }
  ...
  @$pb.TagNumber(9)
  Height ensureConsensusHeight() => $_ensure(8);
