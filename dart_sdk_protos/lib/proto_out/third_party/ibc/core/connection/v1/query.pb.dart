...
class QueryConnectionResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  ConnectionEnd get connection => $_getN(0);
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(1)
  ConnectionEnd ensureConnection() => $_ensure(0);
  ...
  @$pb.TagNumber(3)
  Height get proofHeight => $_getN(2);
  @$pb.TagNumber(3)
  set proofHeight(Height v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  Height ensureProofHeight() => $_ensure(2);
}
...
class QueryConnectionsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'ibc.core.connection.v1'),
      createEmptyInstance: create)
    ..pc<IdentifiedConnection>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'connections',
        $pb.PbFieldType.PM,
        subBuilder: IdentifiedConnection.create)
    ..aOM<PageResponse>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  factory QueryConnectionsResponse({
    $core.Iterable<IdentifiedConnection>? connections,
  ...
  @$pb.TagNumber(1)
  $core.List<IdentifiedConnection> get connections => $_getList(0);
...
class QueryConnectionClientStateResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'ibc.core.connection.v1'),
      createEmptyInstance: create)
    ..aOM<IdentifiedClientState>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'identifiedClientState',
        subBuilder: IdentifiedClientState.create)
    ..a<$core.List<$core.int>>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  @$pb.TagNumber(1)
  IdentifiedClientState get identifiedClientState => $_getN(0);
  @$pb.TagNumber(1)
  set identifiedClientState(IdentifiedClientState v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  IdentifiedClientState ensureIdentifiedClientState() => $_ensure(0);
...
class QueryConnectionConsensusStateResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $0.Any get consensusState => $_getN(0);
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(1)
  $0.Any ensureConsensusState() => $_ensure(0);
  ...
  @$pb.TagNumber(4)
  Height get proofHeight => $_getN(3);
  @$pb.TagNumber(4)
  set proofHeight(Height v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(4)
  Height ensureProofHeight() => $_ensure(3);
}
