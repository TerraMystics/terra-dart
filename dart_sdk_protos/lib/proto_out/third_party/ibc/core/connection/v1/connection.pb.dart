...
import '../../commitment/v1/commitment.pb.dart';
...
class Counterparty extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<MerklePrefix>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'prefix',
        subBuilder: MerklePrefix.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(3)
  MerklePrefix get prefix => $_getN(2);
  @$pb.TagNumber(3)
  set prefix(MerklePrefix v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  MerklePrefix ensurePrefix() => $_ensure(2);
}
