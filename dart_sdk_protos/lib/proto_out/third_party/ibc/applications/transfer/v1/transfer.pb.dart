...
//  source: lib/src/proto/third_party/ibc/applications/transfer/v1/transfer.proto
//
// @dart = 2.12
...
class FungibleTokenPacketData extends $pb.GeneratedMessage {
  ...
  FungibleTokenPacketData copyWith(
      ...
      super.copyWith((message) => updates(message as FungibleTokenPacketData))
          as FungibleTokenPacketData; // ignore: deprecated_member_use
...
class DenomTrace extends $pb.GeneratedMessage {
  ...
  DenomTrace copyWith(void Function(DenomTrace) updates) =>
      super.copyWith((message) => updates(message as DenomTrace))
          as DenomTrace; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
