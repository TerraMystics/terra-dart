...
const QueryAllowancesRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'pagination', '3': 2, '4': 1, '5': 11, '6': '.cosmos.feegrant.v1beta1.PageRequest', '10': 'pagination'},
  ],
};

/// Descriptor for `QueryAllowancesRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryAllowancesRequestDescriptor = $convert.base64Decode('ChZRdWVyeUFsbG93YW5jZXNSZXF1ZXN0EhgKB2dyYW50ZWUYASABKAlSB2dyYW50ZWUSRAoKcGFnaW5hdGlvbhgCIAEoCzIkLmNvc21vcy5mZWVncmFudC52MWJldGExLlBhZ2VSZXF1ZXN0UgpwYWdpbmF0aW9u');
...
const QueryAllowancesResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'pagination', '3': 2, '4': 1, '5': 11, '6': '.cosmos.feegrant.v1beta1.PageResponse', '10': 'pagination'},
  ],
};

/// Descriptor for `QueryAllowancesResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryAllowancesResponseDescriptor = $convert.base64Decode('ChdRdWVyeUFsbG93YW5jZXNSZXNwb25zZRI+CgphbGxvd2FuY2VzGAEgAygLMh4uY29zbW9zLmZlZWdyYW50LnYxYmV0YTEuR3JhbnRSCmFsbG93YW5jZXMSRQoKcGFnaW5hdGlvbhgCIAEoCzIlLmNvc21vcy5mZWVncmFudC52MWJldGExLlBhZ2VSZXNwb25zZVIKcGFnaW5hdGlvbg==');
