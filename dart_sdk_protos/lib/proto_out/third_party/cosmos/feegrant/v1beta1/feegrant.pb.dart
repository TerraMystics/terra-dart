...
import '../../../google/protobuf/duration/duration.pb.dart' as $1;
import '../../../google/protobuf/any/any.pb.dart' as $2;
...
class BasicAllowance extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  $0.Timestamp get expiration => $_getN(1);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(2)
  $0.Timestamp ensureExpiration() => $_ensure(1);
}
...
class PeriodicAllowance extends $pb.GeneratedMessage {
  ...
  factory PeriodicAllowance({
    ...
    $1.Duration? period,
    $core.Iterable<Coin>? periodSpendLimit,
    $core.Iterable<Coin>? periodCanSpend,
    $0.Timestamp? periodReset,
  }) {
    final _result = create();
    if (basic != null) {
      _result.basic = basic;
  ...
  @$pb.TagNumber(3)
  $core.List<Coin> get periodSpendLimit => $_getList(2);

  @$pb.TagNumber(4)
  $core.List<Coin> get periodCanSpend => $_getList(3);

  @$pb.TagNumber(5)
  $0.Timestamp get periodReset => $_getN(4);
  @$pb.TagNumber(5)
  set periodReset($0.Timestamp v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  $0.Timestamp ensurePeriodReset() => $_ensure(4);
}
