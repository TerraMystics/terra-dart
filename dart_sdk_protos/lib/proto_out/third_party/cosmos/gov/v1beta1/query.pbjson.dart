...
//  source: lib/src/proto/third_party/cosmos/gov/v1beta1/query.proto
//
// @dart = 2.12
...
const QueryProposalsRequest$json = const {
  ...
  '2': const [
    const {'1': 'proposal_status', '3': 1, '4': 1, '5': 11, '6': '.cosmos.gov.v1beta1.ProposalStatus', '10': 'proposalStatus'},
    const {'1': 'voter', '3': 2, '4': 1, '5': 9, '10': 'voter'},
    const {'1': 'depositor', '3': 3, '4': 1, '5': 9, '10': 'depositor'},
    const {'1': 'pagination', '3': 4, '4': 1, '5': 11, '6': '.cosmos.gov.v1beta1.PageRequest', '10': 'pagination'},
  ],
  '7': const {},
};

/// Descriptor for `QueryProposalsRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryProposalsRequestDescriptor = $convert.base64Decode('');
...
const QueryProposalsResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'pagination', '3': 2, '4': 1, '5': 11, '6': '.cosmos.gov.v1beta1.PageResponse', '10': 'pagination'},
  ],
};

/// Descriptor for `QueryProposalsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryProposalsResponseDescriptor = $convert.base64Decode('ChZRdWVyeVByb3Bvc2Fsc1Jlc3BvbnNlEkAKCXByb3Bvc2FscxgBIAMoCzIcLmNvc21vcy5nb3YudjFiZXRhMS5Qcm9wb3NhbEIEyN4fAFIJcHJvcG9zYWxzEkAKCnBhZ2luYXRpb24YAiABKAsyIC5jb3Ntb3MuZ292LnYxYmV0YTEuUGFnZVJlc3BvbnNlUgpwYWdpbmF0aW9u');
...
const QueryVotesRequest$json = const {
  ...
  '2': const [
    const {'1': 'proposal_id', '3': 1, '4': 1, '5': 4, '10': 'proposalId'},
    const {'1': 'pagination', '3': 2, '4': 1, '5': 11, '6': '.cosmos.gov.v1beta1.PageRequest', '10': 'pagination'},
  ],
};

/// Descriptor for `QueryVotesRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryVotesRequestDescriptor = $convert.base64Decode('ChFRdWVyeVZvdGVzUmVxdWVzdBIfCgtwcm9wb3NhbF9pZBgBIAEoBFIKcHJvcG9zYWxJZBI/CgpwYWdpbmF0aW9uGAIgASgLMh8uY29zbW9zLmdvdi52MWJldGExLlBhZ2VSZXF1ZXN0UgpwYWdpbmF0aW9u');
...
final $typed_data.Uint8List queryVotesResponseDescriptor = $convert.base64Decode('ChJRdWVyeVZvdGVzUmVzcG9uc2USNAoFdm90ZXMYASADKAsyGC5jb3Ntb3MuZ292LnYxYmV0YTEuVm90ZUIEyN4fAFIFdm90ZXMSQAoKcGFnaW5hdGlvbhgCIAEoCzIgLmNvc21vcy5nb3YudjFiZXRhMS5QYWdlUmVzcG9uc2VSCnBhZ2luYXRpb24=');
...
final $typed_data.Uint8List queryDepositsRequestDescriptor = $convert.base64Decode('ChRRdWVyeURlcG9zaXRzUmVxdWVzdBIfCgtwcm9wb3NhbF9pZBgBIAEoBFIKcHJvcG9zYWxJZBI/CgpwYWdpbmF0aW9uGAIgASgLMh8uY29zbW9zLmdvdi52MWJldGExLlBhZ2VSZXF1ZXN0UgpwYWdpbmF0aW9u');
...
final $typed_data.Uint8List queryDepositsResponseDescriptor = $convert.base64Decode('ChVRdWVyeURlcG9zaXRzUmVzcG9uc2USPQoIZGVwb3NpdHMYASADKAsyGy5jb3Ntb3MuZ292LnYxYmV0YTEuRGVwb3NpdEIEyN4fAFIIZGVwb3NpdHMSQAoKcGFnaW5hdGlvbhgCIAEoCzIgLmNvc21vcy5nb3YudjFiZXRhMS5QYWdlUmVzcG9uc2VSCnBhZ2luYXRpb24=');
...
/// Descriptor for `ProposalStatus`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List proposalStatusDescriptor = $convert.base64Decode('Cg5Qcm9wb3NhbFN0YXR1cw==');
...
final $typed_data.Uint8List tallyResultDescriptor = $convert.base64Decode('CgtUYWxseVJlc3VsdA==');
