...
class MsgSubmitProposal extends $pb.GeneratedMessage {
  ...
  factory MsgSubmitProposal({
    $0.Any? content,
    $core.Iterable<Coin>? initialDeposit,
  ...
  @$pb.TagNumber(1)
  $0.Any ensureContent() => $_ensure(0);

  @$pb.TagNumber(2)
  $core.List<Coin> get initialDeposit => $_getList(1);
...
class MsgVote extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  VoteOption ensureOption() => $_ensure(2);
}
