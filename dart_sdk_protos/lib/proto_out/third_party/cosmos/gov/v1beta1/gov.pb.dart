...
import '../../../google/protobuf/duration/duration.pb.dart' as $2;
...
class Deposit extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  $core.List<Coin> get amount => $_getList(2);
}
...
class Proposal extends $pb.GeneratedMessage {
  ...
  factory Proposal({
    ...
    $1.Timestamp? depositEndTime,
    $core.Iterable<Coin>? totalDeposit,
    $1.Timestamp? votingStartTime,
    $1.Timestamp? votingEndTime,
  }) {
    final _result = create();
    if (proposalId != null) {
      _result.proposalId = proposalId;
  ...
  @$pb.TagNumber(5)
  $1.Timestamp get submitTime => $_getN(4);
  @$pb.TagNumber(5)
  set submitTime($1.Timestamp v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  $1.Timestamp ensureSubmitTime() => $_ensure(4);

  @$pb.TagNumber(6)
  $1.Timestamp get depositEndTime => $_getN(5);
  @$pb.TagNumber(6)
  set depositEndTime($1.Timestamp v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(6)
  $1.Timestamp ensureDepositEndTime() => $_ensure(5);

  @$pb.TagNumber(7)
  $core.List<Coin> get totalDeposit => $_getList(6);

  @$pb.TagNumber(8)
  $1.Timestamp get votingStartTime => $_getN(7);
  @$pb.TagNumber(8)
  set votingStartTime($1.Timestamp v) {
    setField(8, v);
  }
  ...
  @$pb.TagNumber(8)
  $1.Timestamp ensureVotingStartTime() => $_ensure(7);

  @$pb.TagNumber(9)
  $1.Timestamp get votingEndTime => $_getN(8);
  @$pb.TagNumber(9)
  set votingEndTime($1.Timestamp v) {
    setField(9, v);
  }
  ...
  @$pb.TagNumber(9)
  $1.Timestamp ensureVotingEndTime() => $_ensure(8);
}
...
class DepositParams extends $pb.GeneratedMessage {
  ...
  factory DepositParams({
    $core.Iterable<Coin>? minDeposit,
    $2.Duration? maxDepositPeriod,
  }) {
    final _result = create();
    if (minDeposit != null) {
  ...
  @$pb.TagNumber(1)
  $core.List<Coin> get minDeposit => $_getList(0);

  @$pb.TagNumber(2)
  $2.Duration get maxDepositPeriod => $_getN(1);
  @$pb.TagNumber(2)
  set maxDepositPeriod($2.Duration v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $2.Duration ensureMaxDepositPeriod() => $_ensure(1);
}
...
class VotingParams extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $2.Duration get votingPeriod => $_getN(0);
  @$pb.TagNumber(1)
  set votingPeriod($2.Duration v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $2.Duration ensureVotingPeriod() => $_ensure(0);
}
