...
//  source: lib/src/proto/third_party/cosmos/gov/v1beta1/gov.proto
//
// @dart = 2.12
...
final $typed_data.Uint8List depositDescriptor = $convert.base64Decode('');
...
const Proposal$json = const {
  ...
  '2': const [
    ...
    const {'1': 'total_deposit', '3': 7, '4': 3, '5': 11, '6': '.cosmos.gov.v1beta1.Coin', '8': const {}, '10': 'totalDeposit'},
...
final $typed_data.Uint8List proposalDescriptor = $convert.base64Decode('');
...
const DepositParams$json = const {
  '1': 'DepositParams',
  '2': const [
    const {'1': 'min_deposit', '3': 1, '4': 3, '5': 11, '6': '.cosmos.gov.v1beta1.Coin', '8': const {}, '10': 'minDeposit'},
...
final $typed_data.Uint8List depositParamsDescriptor = $convert.base64Decode('');
