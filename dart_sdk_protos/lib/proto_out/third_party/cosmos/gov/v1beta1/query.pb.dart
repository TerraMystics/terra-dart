...
class QueryProposalsRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  ProposalStatus get proposalStatus => $_getN(0);
  @$pb.TagNumber(1)
  set proposalStatus(ProposalStatus v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  ProposalStatus ensureProposalStatus() => $_ensure(0);
...
class QueryParamsResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  VotingParams get votingParams => $_getN(0);
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(1)
  VotingParams ensureVotingParams() => $_ensure(0);

  @$pb.TagNumber(2)
  DepositParams get depositParams => $_getN(1);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(2)
  DepositParams ensureDepositParams() => $_ensure(1);

  @$pb.TagNumber(3)
  TallyParams get tallyParams => $_getN(2);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(3)
  TallyParams ensureTallyParams() => $_ensure(2);
}
...
class QueryTallyResultResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  TallyResult get tally => $_getN(0);
  @$pb.TagNumber(1)
  set tally(TallyResult v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  TallyResult ensureTally() => $_ensure(0);
}
