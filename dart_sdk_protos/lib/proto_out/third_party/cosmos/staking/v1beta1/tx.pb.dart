...
class MsgCreateValidator extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  CommissionRates get commission => $_getN(1);
  @$pb.TagNumber(2)
  set commission(CommissionRates v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  CommissionRates ensureCommission() => $_ensure(1);
  ...
  @$pb.TagNumber(6)
  $0.Any ensurePubkey() => $_ensure(5);

  @$pb.TagNumber(7)
  Coin get value => $_getN(6);
  @$pb.TagNumber(7)
  set value(Coin v) {
    setField(7, v);
  }
...
class MsgBeginRedelegateResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $1.Timestamp get completionTime => $_getN(0);
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(1)
  $1.Timestamp ensureCompletionTime() => $_ensure(0);
}
