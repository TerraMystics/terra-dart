...
class QueryValidatorDelegationsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'cosmos.staking.v1beta1'),
      createEmptyInstance: create)
    ..pc<DelegationResponse>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'delegationResponses',
        $pb.PbFieldType.PM,
        subBuilder: DelegationResponse.create)
    ..aOM<PageResponse>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  factory QueryValidatorDelegationsResponse({
    $core.Iterable<DelegationResponse>? delegationResponses,
    PageResponse? pagination,
  }) {
    final _result = create();
  ...
  @$pb.TagNumber(1)
  $core.List<DelegationResponse> get delegationResponses => $_getList(0);
...
class QueryValidatorUnbondingDelegationsResponse extends $pb.GeneratedMessage {
  ...
  factory QueryValidatorUnbondingDelegationsResponse({
    $core.Iterable<UnbondingDelegation>? unbondingResponses,
    PageResponse? pagination,
  }) {
    final _result = create();
  ...
  @$pb.TagNumber(1)
  $core.List<UnbondingDelegation> get unbondingResponses => $_getList(0);
...
class QueryDelegationResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  DelegationResponse get delegationResponse => $_getN(0);
  @$pb.TagNumber(1)
  set delegationResponse(DelegationResponse v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  DelegationResponse ensureDelegationResponse() => $_ensure(0);
}
...
class QueryUnbondingDelegationResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  UnbondingDelegation get unbond => $_getN(0);
  @$pb.TagNumber(1)
  set unbond(UnbondingDelegation v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  UnbondingDelegation ensureUnbond() => $_ensure(0);
}
...
class QueryRedelegationsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'cosmos.staking.v1beta1'),
      createEmptyInstance: create)
    ..pc<RedelegationResponse>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'redelegationResponses',
        $pb.PbFieldType.PM,
        subBuilder: RedelegationResponse.create)
    ..aOM<PageResponse>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  factory QueryRedelegationsResponse({
    $core.Iterable<RedelegationResponse>? redelegationResponses,
    PageResponse? pagination,
  }) {
    final _result = create();
  ...
  @$pb.TagNumber(1)
  $core.List<RedelegationResponse> get redelegationResponses => $_getList(0);
...
class QueryHistoricalInfoResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<HistoricalInfo>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'hist',
        subBuilder: HistoricalInfo.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  HistoricalInfo get hist => $_getN(0);
  @$pb.TagNumber(1)
  set hist(HistoricalInfo v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  HistoricalInfo ensureHist() => $_ensure(0);
}
