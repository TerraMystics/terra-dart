...
const HistoricalInfo$json = const {
  '1': 'HistoricalInfo',
  '2': const [
    const {'1': 'header', '3': 1, '4': 1, '5': 11, '6': '.cosmos.staking.v1beta1.Header', '8': const {}, '10': 'header'},
...
final $typed_data.Uint8List historicalInfoDescriptor = $convert.base64Decode('Cg5IaXN0b3JpY2FsSW5mbxI8CgZoZWFkZXIYASABKAsyHi5jb3Ntb3Muc3Rha2luZy52MWJldGExLkhlYWRlckIEyN4fAFIGaGVhZGVyEj8KBnZhbHNldBgCIAMoCzIhLmNvc21vcy5zdGFraW5nLnYxYmV0YTEuVmFsaWRhdG9yQgTI3h8AUgZ2YWxzZXQ=');
...
const DelegationResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'balance', '3': 2, '4': 1, '5': 11, '6': '.cosmos.staking.v1beta1.Coin', '8': const {}, '10': 'balance'},
  ],
  '7': const {},
};

/// Descriptor for `DelegationResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List delegationResponseDescriptor = $convert.base64Decode('ChJEZWxlZ2F0aW9uUmVzcG9uc2USSAoKZGVsZWdhdGlvbhgBIAEoCzIiLmNvc21vcy5zdGFraW5nLnYxYmV0YTEuRGVsZWdhdGlvbkIEyN4fAFIKZGVsZWdhdGlvbhI8CgdiYWxhbmNlGAIgASgLMhwuY29zbW9zLnN0YWtpbmcudjFiZXRhMS5Db2luQgTI3h8AUgdiYWxhbmNlOgjooB8AmKAfAA==');
