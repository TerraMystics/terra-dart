...
//  source: lib/src/proto/third_party/cosmos/tx/v1beta1/tx.proto
//
// @dart = 2.12
...
const ModeInfo_Single$json = const {
  '1': 'Single',
  '2': const [
    const {'1': 'mode', '3': 1, '4': 1, '5': 11, '6': '.cosmos.tx.v1beta1.SignMode', '10': 'mode'},
  ],
};
...
const ModeInfo_Multi$json = const {
  '1': 'Multi',
  '2': const [
    const {'1': 'bitarray', '3': 1, '4': 1, '5': 11, '6': '.cosmos.tx.v1beta1.CompactBitArray', '10': 'bitarray'},
...
final $typed_data.Uint8List modeInfoDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use feeDescriptor instead')
const Fee$json = const {
  '1': 'Fee',
  '2': const [
    const {'1': 'amount', '3': 1, '4': 3, '5': 11, '6': '.cosmos.tx.v1beta1.Coin', '8': const {}, '10': 'amount'},
...
final $typed_data.Uint8List feeDescriptor = $convert.base64Decode('CgNGZWUSYQoGYW1vdW50GAEgAygLMhcuY29zbW9zLnR4LnYxYmV0YTEuQ29pbkIwyN4fAKrfHyhnaXRodWIuY29tL2Nvc21vcy9jb3Ntb3Mtc2RrL3R5cGVzLkNvaW5zUgZhbW91bnQSGwoJZ2FzX2xpbWl0GAIgASgEUghnYXNMaW1pdBIUCgVwYXllchgDIAEoCVIFcGF5ZXISGAoHZ3JhbnRlchgEIAEoCVIHZ3JhbnRlcg==');
...
/// Descriptor for `SignMode`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List signModeDescriptor = $convert.base64Decode('CghTaWduTW9kZQ==');
...
final $typed_data.Uint8List compactBitArrayDescriptor = $convert.base64Decode('Cg9Db21wYWN0Qml0QXJyYXk=');
