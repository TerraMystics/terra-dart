...
import '../../crypto/multisig/v1beta1/multisig.pb.dart';
import '../signing/v1beta1/signing.pbenum.dart';
...
class ModeInfo_Multi extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<CompactBitArray>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'bitarray',
        subBuilder: CompactBitArray.create)
    ..pc<ModeInfo>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  @$pb.TagNumber(1)
  CompactBitArray get bitarray => $_getN(0);
  @$pb.TagNumber(1)
  set bitarray(CompactBitArray v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  CompactBitArray ensureBitarray() => $_ensure(0);
...
class Fee extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $core.List<Coin> get amount => $_getList(0);
