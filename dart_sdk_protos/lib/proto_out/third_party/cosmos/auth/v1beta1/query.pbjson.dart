...
//  source: lib/src/proto/third_party/cosmos/auth/v1beta1/query.proto
//
// @dart = 2.12
...
const QueryAccountsRequest$json = const {
  ...
  '2': const [
    const {'1': 'pagination', '3': 1, '4': 1, '5': 11, '6': '.cosmos.auth.v1beta1.PageRequest', '10': 'pagination'},
  ],
};

/// Descriptor for `QueryAccountsRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryAccountsRequestDescriptor = $convert.base64Decode('ChRRdWVyeUFjY291bnRzUmVxdWVzdBJACgpwYWdpbmF0aW9uGAEgASgLMiAuY29zbW9zLmF1dGgudjFiZXRhMS5QYWdlUmVxdWVzdFIKcGFnaW5hdGlvbg==');
...
const QueryAccountsResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'pagination', '3': 2, '4': 1, '5': 11, '6': '.cosmos.auth.v1beta1.PageResponse', '10': 'pagination'},
  ],
};

/// Descriptor for `QueryAccountsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryAccountsResponseDescriptor = $convert.base64Decode('ChVRdWVyeUFjY291bnRzUmVzcG9uc2USPgoIYWNjb3VudHMYASADKAsyFC5nb29nbGUucHJvdG9idWYuQW55QgzKtC0IQWNjb3VudElSCGFjY291bnRzEkEKCnBhZ2luYXRpb24YAiABKAsyIS5jb3Ntb3MuYXV0aC52MWJldGExLlBhZ2VSZXNwb25zZVIKcGFnaW5hdGlvbg==');
