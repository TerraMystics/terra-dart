...
//  source: lib/src/proto/third_party/cosmos/params/v1beta1/query.proto
//
// @dart = 2.12
...
class QueryParamsResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  ParamChange get param => $_getN(0);
  @$pb.TagNumber(1)
  set param(ParamChange v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  ParamChange ensureParam() => $_ensure(0);
}
