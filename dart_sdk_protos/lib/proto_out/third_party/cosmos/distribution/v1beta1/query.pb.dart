...
class QueryValidatorOutstandingRewardsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'cosmos.distribution.v1beta1'),
      createEmptyInstance: create)
    ..aOM<ValidatorOutstandingRewards>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'rewards',
        subBuilder: ValidatorOutstandingRewards.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  ValidatorOutstandingRewards get rewards => $_getN(0);
  @$pb.TagNumber(1)
  set rewards(ValidatorOutstandingRewards v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  ValidatorOutstandingRewards ensureRewards() => $_ensure(0);
}
...
class QueryValidatorCommissionResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  ValidatorAccumulatedCommission get commission => $_getN(0);
  @$pb.TagNumber(1)
  set commission(ValidatorAccumulatedCommission v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  ValidatorAccumulatedCommission ensureCommission() => $_ensure(0);
}
...
class QueryValidatorSlashesResponse extends $pb.GeneratedMessage {
  ...
  factory QueryValidatorSlashesResponse({
    $core.Iterable<ValidatorSlashEvent>? slashes,
  ...
  @$pb.TagNumber(1)
  $core.List<ValidatorSlashEvent> get slashes => $_getList(0);
...
class QueryDelegationRewardsResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $core.List<DecCoin> get rewards => $_getList(0);
}
...
class QueryDelegationTotalRewardsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'cosmos.distribution.v1beta1'),
      createEmptyInstance: create)
    ..pc<DelegationDelegatorReward>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'rewards',
        $pb.PbFieldType.PM,
        subBuilder: DelegationDelegatorReward.create)
    ..pc<DecCoin>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  factory QueryDelegationTotalRewardsResponse({
    $core.Iterable<DelegationDelegatorReward>? rewards,
    $core.Iterable<DecCoin>? total,
  }) {
    final _result = create();
    if (rewards != null) {
      _result.rewards.addAll(rewards);
  ...
  @$pb.TagNumber(1)
  $core.List<DelegationDelegatorReward> get rewards => $_getList(0);

  @$pb.TagNumber(2)
  $core.List<DecCoin> get total => $_getList(1);
}
...
class QueryCommunityPoolResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $core.List<DecCoin> get pool => $_getList(0);
}
