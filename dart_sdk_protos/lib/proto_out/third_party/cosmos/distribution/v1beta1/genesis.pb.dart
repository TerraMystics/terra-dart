...
//  source: lib/src/proto/third_party/cosmos/distribution/v1beta1/genesis.proto
//
// @dart = 2.12
...
class ValidatorOutstandingRewardsRecord extends $pb.GeneratedMessage {
  ...
  factory ValidatorOutstandingRewardsRecord({
    ...
    $core.Iterable<DecCoin>? outstandingRewards,
  }) {
    final _result = create();
  ...
  @$pb.TagNumber(2)
  $core.List<DecCoin> get outstandingRewards => $_getList(1);
}
...
class ValidatorAccumulatedCommissionRecord extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'validatorAddress')
    ..aOM<ValidatorAccumulatedCommission>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'accumulated',
        subBuilder: ValidatorAccumulatedCommission.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  ValidatorAccumulatedCommission get accumulated => $_getN(1);
  @$pb.TagNumber(2)
  set accumulated(ValidatorAccumulatedCommission v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  ValidatorAccumulatedCommission ensureAccumulated() => $_ensure(1);
}
...
class ValidatorHistoricalRewardsRecord extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<ValidatorHistoricalRewards>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'rewards',
        subBuilder: ValidatorHistoricalRewards.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(3)
  ValidatorHistoricalRewards get rewards => $_getN(2);
  @$pb.TagNumber(3)
  set rewards(ValidatorHistoricalRewards v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  ValidatorHistoricalRewards ensureRewards() => $_ensure(2);
}
...
class ValidatorCurrentRewardsRecord extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'validatorAddress')
    ..aOM<ValidatorCurrentRewards>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'rewards',
        subBuilder: ValidatorCurrentRewards.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  ValidatorCurrentRewards get rewards => $_getN(1);
  @$pb.TagNumber(2)
  set rewards(ValidatorCurrentRewards v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  ValidatorCurrentRewards ensureRewards() => $_ensure(1);
}
...
class DelegatorStartingInfoRecord extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'validatorAddress')
    ..aOM<DelegatorStartingInfo>(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'startingInfo',
        subBuilder: DelegatorStartingInfo.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(3)
  DelegatorStartingInfo get startingInfo => $_getN(2);
  @$pb.TagNumber(3)
  set startingInfo(DelegatorStartingInfo v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  DelegatorStartingInfo ensureStartingInfo() => $_ensure(2);
}
...
class ValidatorSlashEventRecord extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  ValidatorSlashEvent get validatorSlashEvent => $_getN(3);
  @$pb.TagNumber(4)
  set validatorSlashEvent(ValidatorSlashEvent v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(4)
  ValidatorSlashEvent ensureValidatorSlashEvent() => $_ensure(3);
}
...
class GenesisState extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  FeePool get feePool => $_getN(1);
  @$pb.TagNumber(2)
  set feePool(FeePool v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  FeePool ensureFeePool() => $_ensure(1);
