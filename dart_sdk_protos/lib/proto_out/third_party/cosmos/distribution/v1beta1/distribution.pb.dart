...
class ValidatorHistoricalRewards extends $pb.GeneratedMessage {
  ...
  factory ValidatorHistoricalRewards({
    $core.Iterable<DecCoin>? cumulativeRewardRatio,
  ...
  @$pb.TagNumber(1)
  $core.List<DecCoin> get cumulativeRewardRatio => $_getList(0);
...
class ValidatorAccumulatedCommission extends $pb.GeneratedMessage {
  ...
  factory ValidatorAccumulatedCommission({
    $core.Iterable<DecCoin>? commission,
  }) {
    final _result = create();
    if (commission != null) {
  ...
  @$pb.TagNumber(1)
  $core.List<DecCoin> get commission => $_getList(0);
}
...
class FeePool extends $pb.GeneratedMessage {
  ...
  FeePool._() : super();
  factory FeePool({
    $core.Iterable<DecCoin>? communityPool,
  }) {
    final _result = create();
  ...
  @$pb.TagNumber(1)
  $core.List<DecCoin> get communityPool => $_getList(0);
}
...
class CommunityPoolSpendProposal extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  $core.List<Coin> get amount => $_getList(3);
}
...
class DelegationDelegatorReward extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  $core.List<DecCoin> get reward => $_getList(1);
}
