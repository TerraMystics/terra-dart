...
//  source: lib/src/proto/third_party/cosmos/distribution/v1beta1/tx.proto
//
// @dart = 2.12
...
const MsgFundCommunityPool$json = const {
  ...
  '2': const [
    const {'1': 'amount', '3': 1, '4': 3, '5': 11, '6': '.cosmos.distribution.v1beta1.Coin', '8': const {}, '10': 'amount'},
...
final $typed_data.Uint8List msgFundCommunityPoolDescriptor = $convert.base64Decode('ChRNc2dGdW5kQ29tbXVuaXR5UG9vbBJrCgZhbW91bnQYASADKAsyIS5jb3Ntb3MuZGlzdHJpYnV0aW9uLnYxYmV0YTEuQ29pbkIwyN4fAKrfHyhnaXRodWIuY29tL2Nvc21vcy9jb3Ntb3Mtc2RrL3R5cGVzLkNvaW5zUgZhbW91bnQSHAoJZGVwb3NpdG9yGAIgASgJUglkZXBvc2l0b3I6COigHwCIoB8A');
