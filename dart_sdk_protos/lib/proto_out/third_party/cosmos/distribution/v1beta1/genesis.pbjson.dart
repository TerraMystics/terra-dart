...
const ValidatorOutstandingRewardsRecord$json = const {
  ...
  '2': const [
    ...
    const {'1': 'outstanding_rewards', '3': 2, '4': 3, '5': 11, '6': '.cosmos.distribution.v1beta1.DecCoin', '8': const {}, '10': 'outstandingRewards'},
  ],
  '7': const {},
};

/// Descriptor for `ValidatorOutstandingRewardsRecord`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List validatorOutstandingRewardsRecordDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List validatorCurrentRewardsDescriptor = $convert.base64Decode('ChdWYWxpZGF0b3JDdXJyZW50UmV3YXJkcw==');
...
final $typed_data.Uint8List feePoolDescriptor = $convert.base64Decode('CgdGZWVQb29s');
...
final $typed_data.Uint8List delegatorStartingInfoDescriptor = $convert.base64Decode('ChVEZWxlZ2F0b3JTdGFydGluZ0luZm8=');
...
final $typed_data.Uint8List validatorHistoricalRewardsDescriptor = $convert.base64Decode('ChpWYWxpZGF0b3JIaXN0b3JpY2FsUmV3YXJkcw==');
