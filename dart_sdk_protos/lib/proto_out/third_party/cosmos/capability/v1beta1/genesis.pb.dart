...
//  source: lib/src/proto/third_party/cosmos/capability/v1beta1/genesis.proto
//
// @dart = 2.12
...
class GenesisOwners extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<CapabilityOwners>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'indexOwners',
        subBuilder: CapabilityOwners.create)
    ..hasRequiredFields = false;

  GenesisOwners._() : super();
  factory GenesisOwners({
    $fixnum.Int64? index,
    CapabilityOwners? indexOwners,
  }) {
  ...
  @$pb.TagNumber(2)
  CapabilityOwners get indexOwners => $_getN(1);
  @$pb.TagNumber(2)
  set indexOwners(CapabilityOwners v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  CapabilityOwners ensureIndexOwners() => $_ensure(1);
}
