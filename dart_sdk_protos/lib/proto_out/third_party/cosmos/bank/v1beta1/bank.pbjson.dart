...
final $typed_data.Uint8List inputDescriptor = $convert.base64Decode('CgVJbnB1dBIYCgdhZGRyZXNzGAEgASgJUgdhZGRyZXNzEmEKBWNvaW5zGAIgAygLMhkuY29zbW9zLmJhbmsudjFiZXRhMS5Db2luQjDI3h8Aqt8fKGdpdGh1Yi5jb20vY29zbW9zL2Nvc21vcy1zZGsvdHlwZXMuQ29pbnNSBWNvaW5zOgjooB8AiKAfAA==');
...
final $typed_data.Uint8List outputDescriptor = $convert.base64Decode('CgZPdXRwdXQSGAoHYWRkcmVzcxgBIAEoCVIHYWRkcmVzcxJhCgVjb2lucxgCIAMoCzIZLmNvc21vcy5iYW5rLnYxYmV0YTEuQ29pbkIwyN4fAKrfHyhnaXRodWIuY29tL2Nvc21vcy9jb3Ntb3Mtc2RrL3R5cGVzLkNvaW5zUgVjb2luczoI6KAfAIigHwA=');
@$core.Deprecated('Use supplyDescriptor instead')
const Supply$json = const {
  '1': 'Supply',
  '2': const [
    const {'1': 'total', '3': 1, '4': 3, '5': 11, '6': '.cosmos.bank.v1beta1.Coin', '8': const {}, '10': 'total'},
  ],
  '7': const {'3': true},
};

/// Descriptor for `Supply`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List supplyDescriptor = $convert.base64Decode('CgZTdXBwbHkSYQoFdG90YWwYASADKAsyGS5jb3Ntb3MuYmFuay52MWJldGExLkNvaW5CMMjeHwCq3x8oZ2l0aHViLmNvbS9jb3Ntb3MvY29zbW9zLXNkay90eXBlcy5Db2luc1IFdG90YWw6RhgB6KAfAYigHwDStC04KmdpdGh1Yi5jb20vY29zbW9zL2Nvc21vcy1zZGsveC9iYW5rL2xlZ2FjeS92MDQwLlN1cHBseUk=');
