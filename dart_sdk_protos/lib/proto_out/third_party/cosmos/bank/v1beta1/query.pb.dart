...
class QueryAllBalancesResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $core.List<Coin> get balances => $_getList(0);
...
class QueryTotalSupplyResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  $core.List<Coin> get supply => $_getList(0);
...
class QueryDenomsMetadataResponse extends $pb.GeneratedMessage {
  ...
  factory QueryDenomsMetadataResponse({
    $core.Iterable<Metadata>? metadatas,
    PageResponse? pagination,
  }) {
    final _result = create();
    if (metadatas != null) {
  ...
  @$pb.TagNumber(1)
  $core.List<Metadata> get metadatas => $_getList(0);
