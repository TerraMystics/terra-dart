...
class QuerySigningInfoResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'cosmos.slashing.v1beta1'),
      createEmptyInstance: create)
    ..aOM<ValidatorSigningInfo>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'valSigningInfo',
        subBuilder: ValidatorSigningInfo.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  ValidatorSigningInfo get valSigningInfo => $_getN(0);
  @$pb.TagNumber(1)
  set valSigningInfo(ValidatorSigningInfo v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  ValidatorSigningInfo ensureValSigningInfo() => $_ensure(0);
}
...
class QuerySigningInfosResponse extends $pb.GeneratedMessage {
  ...
  factory QuerySigningInfosResponse({
    $core.Iterable<ValidatorSigningInfo>? info,
  ...
  @$pb.TagNumber(1)
  $core.List<ValidatorSigningInfo> get info => $_getList(0);
