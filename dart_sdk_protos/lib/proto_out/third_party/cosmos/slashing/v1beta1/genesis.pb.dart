...
//  source: lib/src/proto/third_party/cosmos/slashing/v1beta1/genesis.proto
//
// @dart = 2.12
...
class SigningInfo extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  ValidatorSigningInfo get validatorSigningInfo => $_getN(1);
  @$pb.TagNumber(2)
  set validatorSigningInfo(ValidatorSigningInfo v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  ValidatorSigningInfo ensureValidatorSigningInfo() => $_ensure(1);
}
