...
//  source: lib/src/proto/third_party/cosmos/slashing/v1beta1/query.proto
//
// @dart = 2.12
...
const QuerySigningInfosRequest$json = const {
  ...
  '2': const [
    const {'1': 'pagination', '3': 1, '4': 1, '5': 11, '6': '.cosmos.slashing.v1beta1.PageRequest', '10': 'pagination'},
  ],
};

/// Descriptor for `QuerySigningInfosRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List querySigningInfosRequestDescriptor = $convert.base64Decode('ChhRdWVyeVNpZ25pbmdJbmZvc1JlcXVlc3QSRAoKcGFnaW5hdGlvbhgBIAEoCzIkLmNvc21vcy5zbGFzaGluZy52MWJldGExLlBhZ2VSZXF1ZXN0UgpwYWdpbmF0aW9u');
...
const QuerySigningInfosResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'pagination', '3': 2, '4': 1, '5': 11, '6': '.cosmos.slashing.v1beta1.PageResponse', '10': 'pagination'},
  ],
};

/// Descriptor for `QuerySigningInfosResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List querySigningInfosResponseDescriptor = $convert.base64Decode('ChlRdWVyeVNpZ25pbmdJbmZvc1Jlc3BvbnNlEkcKBGluZm8YASADKAsyLS5jb3Ntb3Muc2xhc2hpbmcudjFiZXRhMS5WYWxpZGF0b3JTaWduaW5nSW5mb0IEyN4fAFIEaW5mbxJFCgpwYWdpbmF0aW9uGAIgASgLMiUuY29zbW9zLnNsYXNoaW5nLnYxYmV0YTEuUGFnZVJlc3BvbnNlUgpwYWdpbmF0aW9u');
...
final $typed_data.Uint8List validatorSigningInfoDescriptor = $convert.base64Decode('ChRWYWxpZGF0b3JTaWduaW5nSW5mbw==');
