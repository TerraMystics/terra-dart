...
//  source: lib/src/proto/third_party/cosmos/base/abci/v1beta1/abci.proto
//
// @dart = 2.12
...
const TxResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'events', '3': 13, '4': 3, '5': 11, '6': '.cosmos.base.abci.v1beta1.Event', '8': const {}, '10': 'events'},
  ],
  '7': const {},
};

/// Descriptor for `TxResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List txResponseDescriptor = $convert.base64Decode('');
...
const Result$json = const {
  ...
  '2': const [
    ...
    const {'1': 'log', '3': 2, '4': 1, '5': 9, '10': 'log'},
    const {'1': 'events', '3': 3, '4': 3, '5': 11, '6': '.cosmos.base.abci.v1beta1.Event', '8': const {}, '10': 'events'},
  ],
  '7': const {},
};

/// Descriptor for `Result`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List resultDescriptor = $convert.base64Decode('CgZSZXN1bHQSEgoEZGF0YRgBIAEoDFIEZGF0YRIQCgNsb2cYAiABKAlSA2xvZxI9CgZldmVudHMYAyADKAsyHy5jb3Ntb3MuYmFzZS5hYmNpLnYxYmV0YTEuRXZlbnRCBMjeHwBSBmV2ZW50czoEiKAfAA==');
...
final $typed_data.Uint8List eventDescriptor = $convert.base64Decode('CgVFdmVudA==');
