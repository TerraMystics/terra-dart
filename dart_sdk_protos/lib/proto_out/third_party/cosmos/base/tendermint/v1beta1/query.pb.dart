...
import '../../../../tendermint/p2p/types.pb.dart';
import '../../../../tendermint/types/block.pb.dart';
import '../../../../tendermint/types/types.pb.dart';
import '../../query/v1beta1/pagination.pb.dart';
...
class GetNodeInfoResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<DefaultNodeInfo>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'defaultNodeInfo',
        subBuilder: DefaultNodeInfo.create)
    ..aOM<VersionInfo>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  @$pb.TagNumber(1)
  DefaultNodeInfo get defaultNodeInfo => $_getN(0);
  @$pb.TagNumber(1)
  set defaultNodeInfo(DefaultNodeInfo v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  DefaultNodeInfo ensureDefaultNodeInfo() => $_ensure(0);
